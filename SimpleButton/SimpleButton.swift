...
open class SimpleButton: UIButton {
    ...
    */
    ...
    /**
    Sets the scale for a specific `UIControl.State`
    ...
    */
    ...
    /**
     Sets the background color for a specific `UIControl.State`
    ...
    /**
     Sets the border width for a specific `UIControl.State`
    ...
    /**
     Sets the border color for a specific `UIControl.State`
    ...
    /**
     Sets the corner radius for a specific `UIControl.State`
    ...
    /**
     Sets the shadow color for a specific `UIControl.State`
    ...
    /**
     Sets the shadow opacity for a specific `UIControl.State`
    ...
    /**
     Sets the shadow radius for a specific `UIControl.State`
    ...
    /**
     Sets the shadow offset for a specific `UIControl.State`
